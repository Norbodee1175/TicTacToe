...
const Board = () => {
  ...
  const { dimension, squares, winner, winnerLine, xnext, ties, activeUser, playMode, handleUndo } =
  ...
  useEffect(() => {
    boardRef.current.style.setProperty("--size", dimension);
  }, []);
  ...
  return (
    <div className="board" ref={boardRef}>
      ...
      <div className="board__footer">
        ...
        <button className="btn-undo" onClick={handleUndo}>Replay</button>
      </div>
    </div>
  );
};
